...
public class PostActivity extends AppCompatActivity {
    ...
    private void startPosting() {
        ...
        if (!TextUtils.isEmpty(title_val) && !TextUtils.isEmpty(desc_val) && mIamgeUri != null) {

            mProgress.show();

            StorageReference filepath = mStorage.child("Blog_Images").child(mIamgeUri.getLastPathSegment());
            ...
            Toast.makeText(this, "Silahkan diisi dengan Benar", Toast.LENGTH_SHORT).show();
            mProgress.dismiss();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GALLERY_REQUEST && resultCode == RESULT_OK) {
            ...
            mSelectImage.setImageURI(mIamgeUri);
        }
    }
}
